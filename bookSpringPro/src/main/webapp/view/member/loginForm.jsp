...
<link rel="stylesheet" href="<%=request.getContextPath() %>/css/memberCss/loginForm.css">
</head>
<body>
...
<form action="<%=request.getContextPath() %>/member/loginPro" method="post" id="form">
...
<table class="table">
	...
	<tr>
		<td colspan="3" class="memberinput">
			아직 회원이 아니신가요? &nbsp &nbsp
			<a href="<%=request.getContextPath() %>/member/memberInput">[회원가입]</a>
		</td>
	</tr>
</table>
